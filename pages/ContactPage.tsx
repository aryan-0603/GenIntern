...
const ContactPage: React.FC = () => {
  ...
  return (
    <>
      <PageHeader title="Get In Touch" subtitle="Have questions? We’d love to hear from you." />
            ...
            <AnimatedSection className="lg:w-1/3">
              <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 h-full">
                ...
                <ul className="space-y-4 text-gray-600 dark:text-gray-300">
                  <li className="flex items-center gap-4"><FaEnvelope className="text-cyan-500 dark:text-cyan-400" /> contact.genintern@gmail.com</li>
                  <li className="flex items-center gap-4"><FaMapMarkerAlt className="text-cyan-500 dark:text-cyan-400" /> Delhi, India</li>
                </ul>
              </div>
            </AnimatedSection>
