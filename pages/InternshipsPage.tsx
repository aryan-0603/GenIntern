            ...
            {internshipTracks.map((track, index) => (
              <AnimatedSection key={index}>
                <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 h-full flex flex-col text-center hover:-translate-y-2 transition-transform duration-300">
                  ...
                  <a href="https://forms.gle/Y4q6y2uT3puVNu6T6" target="_blank" rel="noopener noreferrer" className="mt-auto inline-block bg-gradient-to-r from-cyan-400 to-orange-400 text-gray-900 font-bold py-2 px-6 rounded-lg hover:shadow-xl transition-shadow">
                    Apply Now
                  </a>
                </div>
              </AnimatedSection>
